...
// 브라우저가 HMTL 문서에 모든 요소들을 생성하고 난 후, 이벤트 리스너 함수를 실행.
// 함수의 역할은 함수를 정의해 놓았다가 이벤트가 발생하면 실행.
document.addEventListener('DOMContentLoaded', function () {
    ...
    // 찾은 HTML 요소에 'click' 이베트 리스너를 등록:
    // addEventListener('eventName', callback);
    // callback(eventListener function): 이벤트가 발생했을 때 브라우저가 호출하는 함수. 이벤트를 처리하는 함수.
